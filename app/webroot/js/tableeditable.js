var TableEditable = function () {
    ...
    return {
        ...
        init: function () {
            ...
            jQuery('#sample_editable_1_wrapper .dataTables_filter input').addClass("m-wrap medium"); // modify table  input
            ...
            $('#sample_editable_1_new').click(function (e) {
                ...
                var aiNew = oTable.fnAddData(['', '', '', '',
                        '<a class="edit" href="">Edit</a>', '<a class="cancel" data-mode="new" href="">Annuler</a>'
                ]);
